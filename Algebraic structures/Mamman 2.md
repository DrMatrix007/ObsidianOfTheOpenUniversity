...
האיבר $\beta$ הוא מסדר 2 או איבר היחידה,
האיבר $\alpha$ הוא מסדר $n$ או מסדר המחלק את $n$
...
לכן, ניתן להסיק כי $i=4$ .
מש"ל ד
# סעיף ה
קיבלנו שיש איבר מסדר 2, ואיבר מסדר 5. כאשר מתקיים
$$\alpha^2 = \sigma^5 = e, \space \sigma \alpha = \alpha \sigma^4$$
זו ההגדרה של חבורה דיהדרלית על מצולע בעל 5 צלעות.
לכן היא איזומטרית לחבורה הדיהדרלית מסדר 5 (בעלת 10 האיברים).
מש"ל ה